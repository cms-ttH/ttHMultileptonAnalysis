...
def main ():
    ...
    parser.add_argument('-hd', '--hadoop', action='store_true', default=False, help='send output to /hadoop/users/USER/tree_files instead of AFS')
    ...
    dataNames2012_53x = {"DoubleElectron":['DoubleElectron_Run2012A-13Jul2012-v1',
                         ...
                         "MET":['MET_Run2012A-13Jul2012-v1',
                                 'MET_Run2012A-recover-06Aug2012-v1',
                                 'MET_Run2012B-13Jul2012-v1',
                                 'MET_Run2012C-PromptReco-v2',
                                 'MET_Run2012C-24Aug2012-v1',
                                 'MET_Run2012D-PromptReco-v1'],
