...
public:
  ...
  MatchTester_ttW_SS(BNleptonCollection **_leptons, BNjetCollection **_jets, BNmetCollection **_mets);
  ~MatchTester_ttW_SS();
  void evaluate();
};

MatchTester_ttW_SS::MatchTester_ttW_SS(BNleptonCollection **_leptons, BNjetCollection **_jets, BNmetCollection **_mets):
  leptons(_leptons), jets(_jets), mets(_mets) {

  //std::cout << "Initializing MatchTester_ttW_SS" << std::endl;

  //this->resetVal = 0.0; //What does this do?
  this->resetVal = KinematicVariableConstants::FLOAT_INIT; //What does this do?

  branches["Match_ttW_SS_Bb"] = BranchInfo<double>("Match_ttW_SS_Bb");
  branches["Match_ttW_SS_Bq"] = BranchInfo<double>("Match_ttW_SS_Bq");
  branches["Match_ttW_SS_bq"] = BranchInfo<double>("Match_ttW_SS_bq");
  branches["Match_ttW_SS_Bbq"] = BranchInfo<double>("Match_ttW_SS_Bbq");
  branches["Match_ttW_SS_Bqq"] = BranchInfo<double>("Match_ttW_SS_Bqq");
  branches["Match_ttW_SS_bqq"] = BranchInfo<double>("Match_ttW_SS_bqq");
  branches["Match_ttW_SS_Bbqq"] = BranchInfo<double>("Match_ttW_SS_Bbqq");

  branches["Full_match_ttW_SS_Bb"] = BranchInfo<double>("Full_match_ttW_SS_Bb");
  branches["Full_match_ttW_SS_Bq"] = BranchInfo<double>("Full_match_ttW_SS_Bq");
  branches["Full_match_ttW_SS_bq"] = BranchInfo<double>("Full_match_ttW_SS_bq");
  branches["Full_match_ttW_SS_Bbq"] = BranchInfo<double>("Full_match_ttW_SS_Bbq");
  branches["Full_match_ttW_SS_Bqq"] = BranchInfo<double>("Full_match_ttW_SS_Bqq");
  branches["Full_match_ttW_SS_bqq"] = BranchInfo<double>("Full_match_ttW_SS_bqq");
  branches["Full_match_ttW_SS_Bbqq"] = BranchInfo<double>("Full_match_ttW_SS_Bbqq");

  branches["ttW_SS_B_CSV"] = BranchInfo<double>("ttW_SS_B_CSV");
  branches["ttW_SS_b_CSV"] = BranchInfo<double>("ttW_SS_b_CSV");
  branches["ttW_SS_q_1_CSV"] = BranchInfo<double>("ttW_SS_q_1_CSV");
  branches["ttW_SS_q_2_CSV"] = BranchInfo<double>("ttW_SS_q_2_CSV");
  branches["ttW_SS_B_charge"] = BranchInfo<double>("ttW_SS_B_charge");
  branches["ttW_SS_b_charge"] = BranchInfo<double>("ttW_SS_b_charge");
  branches["ttW_SS_W_mass_qq"] = BranchInfo<double>("ttW_SS_W_mass_qq");
  branches["ttW_SS_W_sum_charge_qq"] = BranchInfo<double>("ttW_SS_W_sum_charge_qq");
  branches["ttW_SS_top_mass_lep_B"] = BranchInfo<double>("ttW_SS_top_mass_lep_B");
  branches["ttW_SS_top_mass_b_q"] = BranchInfo<double>("ttW_SS_top_mass_b_q");
  branches["ttW_SS_top_mass_b_qq"] = BranchInfo<double>("ttW_SS_top_mass_b_qq");
  branches["ttW_SS_ttbar_2j_MT_mass_ratio_Bb"] = BranchInfo<double>("ttW_SS_ttbar_2j_MT_mass_ratio_Bb");
  branches["ttW_SS_ttbar_2j_MT_mass_ratio_Bq"] = BranchInfo<double>("ttW_SS_ttbar_2j_MT_mass_ratio_Bq");
  branches["ttW_SS_ttbar_2j_MT_mass_ratio_bq"] = BranchInfo<double>("ttW_SS_ttbar_2j_MT_mass_ratio_bq");
  branches["ttW_SS_ttbar_3j_MT_mass_ratio_Bbq"] = BranchInfo<double>("ttW_SS_ttbar_3j_MT_mass_ratio_Bbq");
  branches["ttW_SS_ttbar_3j_MT_mass_ratio_Bqq"] = BranchInfo<double>("ttW_SS_ttbar_3j_MT_mass_ratio_Bqq");
  branches["ttW_SS_ttbar_3j_MT_mass_ratio_bqq"] = BranchInfo<double>("ttW_SS_ttbar_3j_MT_mass_ratio_bqq");
  branches["ttW_SS_ttbar_4j_MT_mass_ratio_Bbqq"] = BranchInfo<double>("ttW_SS_ttbar_4j_MT_mass_ratio_Bbqq");

  branches["Match_ttW_SS_Bb"].branchVal = KinematicVariableConstants::FLOAT_INIT; 
  branches["Match_ttW_SS_Bq"].branchVal = KinematicVariableConstants::FLOAT_INIT; 
  branches["Match_ttW_SS_bq"].branchVal = KinematicVariableConstants::FLOAT_INIT; 
  branches["Match_ttW_SS_Bbq"].branchVal = KinematicVariableConstants::FLOAT_INIT; 
  branches["Match_ttW_SS_Bqq"].branchVal = KinematicVariableConstants::FLOAT_INIT; 
  branches["Match_ttW_SS_bqq"].branchVal = KinematicVariableConstants::FLOAT_INIT; 
  branches["Match_ttW_SS_Bbqq"].branchVal = KinematicVariableConstants::FLOAT_INIT; 

  branches["Full_match_ttW_SS_Bb"].branchVal = 0.0; 
  branches["Full_match_ttW_SS_Bq"].branchVal = 0.0; 
  branches["Full_match_ttW_SS_bq"].branchVal = 0.0; 
  branches["Full_match_ttW_SS_Bbq"].branchVal = 0.0; 
  branches["Full_match_ttW_SS_Bqq"].branchVal = 0.0; 
  branches["Full_match_ttW_SS_bqq"].branchVal = 0.0; 
  branches["Full_match_ttW_SS_Bbqq"].branchVal = 0.0; 

  branches["ttW_SS_B_CSV"].branchVal = KinematicVariableConstants::FLOAT_INIT; 
  branches["ttW_SS_b_CSV"].branchVal = KinematicVariableConstants::FLOAT_INIT;
  branches["ttW_SS_q_1_CSV"].branchVal = KinematicVariableConstants::FLOAT_INIT;
  branches["ttW_SS_q_2_CSV"].branchVal = KinematicVariableConstants::FLOAT_INIT;
  branches["ttW_SS_B_charge"].branchVal = KinematicVariableConstants::FLOAT_INIT;
  branches["ttW_SS_b_charge"].branchVal = KinematicVariableConstants::FLOAT_INIT;
  branches["ttW_SS_W_mass_qq"].branchVal = KinematicVariableConstants::FLOAT_INIT;
  branches["ttW_SS_W_sum_charge_qq"].branchVal = KinematicVariableConstants::FLOAT_INIT;
  branches["ttW_SS_top_mass_lep_B"].branchVal = KinematicVariableConstants::FLOAT_INIT;
  branches["ttW_SS_top_mass_b_q"].branchVal = KinematicVariableConstants::FLOAT_INIT;
  branches["ttW_SS_top_mass_b_qq"].branchVal = KinematicVariableConstants::FLOAT_INIT;
  branches["ttW_SS_ttbar_2j_MT_mass_ratio_Bb"].branchVal = KinematicVariableConstants::FLOAT_INIT;
  branches["ttW_SS_ttbar_2j_MT_mass_ratio_Bq"].branchVal = KinematicVariableConstants::FLOAT_INIT;
  branches["ttW_SS_ttbar_2j_MT_mass_ratio_bq"].branchVal = KinematicVariableConstants::FLOAT_INIT;
  branches["ttW_SS_ttbar_3j_MT_mass_ratio_Bbq"].branchVal = KinematicVariableConstants::FLOAT_INIT;
  branches["ttW_SS_ttbar_3j_MT_mass_ratio_Bqq"].branchVal = KinematicVariableConstants::FLOAT_INIT;
  branches["ttW_SS_ttbar_3j_MT_mass_ratio_bqq"].branchVal = KinematicVariableConstants::FLOAT_INIT;
  ...
  //std::cout << "Finished initializing MatchTester_ttW_SS" << std::endl;
}

void MatchTester_ttW_SS::evaluate() {
  if (this->evaluatedThisEvent) return;
  evaluatedThisEvent = true;

  //std::cout << "Evaluating MatchTester_ttW_SS" << std::endl;
  ...
  for (unsigned int iLep = 0; iLep < 2; iLep++) {
    lep_vect.SetPtEtaPhiE((*leptons)->at(iLep)->pt, (*leptons)->at(iLep)->eta, (*leptons)->at(iLep)->phi, (*leptons)->at(iLep)->energy);
    lep_vect_trans.SetPtEtaPhiE((*leptons)->at(iLep)->pt, 0.0, (*leptons)->at(iLep)->phi, (*leptons)->at(iLep)->pt);
    for (unsigned int iJet1 = 0; iJet1 < (*jets)->size(); iJet1++) {    
      ...
      for (unsigned int iJet2 = 0; iJet2 < (*jets)->size(); iJet2++) {
        ...
        if (log(ratio_Bb) > branches["Match_ttW_SS_Bb"].branchVal) {
          branches["Match_ttW_SS_Bb"].branchVal = log(ratio_Bb);
          branches["Full_match_ttW_SS_Bb"].branchVal = ((*jets)->at(iJet1).genPartonMotherId == 6*lep_charge &&
                                                        (*jets)->at(iJet2).genPartonMotherId == -6*lep_charge);
          branches["ttW_SS_B_CSV"].branchVal = (*jets)->at(iJet1).btagCombinedSecVertex;
          branches["ttW_SS_b_CSV"].branchVal = (*jets)->at(iJet2).btagCombinedSecVertex;
          branches["ttW_SS_B_charge"].branchVal = lep_charge*(*jets)->at(iJet1).charge;
          branches["ttW_SS_b_charge"].branchVal = lep_charge*(*jets)->at(iJet2).charge;
          branches["ttW_SS_top_mass_lep_B"].branchVal = top_mass_lep_B;
          branches["ttW_SS_ttbar_2j_MT_mass_ratio_Bb"].branchVal = jet_12_vect_trans.M()/jet_12_vect.M();
        }
        ...
        if (log(ratio_Bq) > branches["Match_ttW_SS_Bq"].branchVal) {
          branches["Match_ttW_SS_Bq"].branchVal = log(ratio_Bq);
          branches["Full_match_ttW_SS_Bq"].branchVal = ((*jets)->at(iJet1).genPartonMotherId == 6*lep_charge &&
                                                        abs((*jets)->at(iJet2).genPartonMotherId) == 24);
          branches["ttW_SS_B_CSV"].branchVal = (*jets)->at(iJet1).btagCombinedSecVertex;
          branches["ttW_SS_q_1_CSV"].branchVal = (*jets)->at(iJet2).btagCombinedSecVertex;
          branches["ttW_SS_B_charge"].branchVal = lep_charge*(*jets)->at(iJet1).charge;
          branches["ttW_SS_top_mass_lep_B"].branchVal = top_mass_lep_B;
          branches["ttW_SS_ttbar_2j_MT_mass_ratio_Bq"].branchVal = jet_12_vect_trans.M()/jet_12_vect.M();
        }
        ...
        if (log(ratio_bq) > branches["Match_ttW_SS_bq"].branchVal) {
          ...
          branches["ttW_SS_q_1_CSV"].branchVal = (*jets)->at(iJet2).btagCombinedSecVertex;
          branches["ttW_SS_b_charge"].branchVal = lep_charge*(*jets)->at(iJet1).charge;
          branches["ttW_SS_top_mass_b_q"].branchVal = top_mass_b_q;
          branches["ttW_SS_ttbar_2j_MT_mass_ratio_bq"].branchVal = jet_12_vect_trans.M()/jet_12_vect.M();
        }
        ...
        for (unsigned int iJet3 = 0; iJet3 < (*jets)->size(); iJet3++) {
          ...
          if (log(ratio_Bbq) > branches["Match_ttW_SS_Bbq"].branchVal) {
            branches["Match_ttW_SS_Bbq"].branchVal = log(ratio_Bbq);
            branches["Full_match_ttW_SS_Bbq"].branchVal = ((*jets)->at(iJet1).genPartonMotherId == 6*lep_charge &&
                                                           (*jets)->at(iJet2).genPartonMotherId == -6*lep_charge &&
                                                           abs((*jets)->at(iJet3).genPartonMotherId) == 24);
            branches["ttW_SS_B_CSV"].branchVal = (*jets)->at(iJet1).btagCombinedSecVertex;
            branches["ttW_SS_b_CSV"].branchVal = (*jets)->at(iJet2).btagCombinedSecVertex;
            branches["ttW_SS_q_1_CSV"].branchVal = (*jets)->at(iJet3).btagCombinedSecVertex;
            branches["ttW_SS_B_charge"].branchVal = lep_charge*(*jets)->at(iJet1).charge;
            branches["ttW_SS_b_charge"].branchVal = lep_charge*(*jets)->at(iJet2).charge;
            branches["ttW_SS_top_mass_lep_B"].branchVal = top_mass_lep_B;
            branches["ttW_SS_top_mass_b_q"].branchVal = top_mass_b_q;
            branches["ttW_SS_ttbar_3j_MT_mass_ratio_Bbq"].branchVal = jet_123_vect_trans.M()/jet_123_vect.M();
          }
          ...
          if (log(ratio_Bqq) > branches["Match_ttW_SS_Bqq"].branchVal) {
            branches["Match_ttW_SS_Bqq"].branchVal = log(ratio_Bqq);
            branches["Full_match_ttW_SS_Bqq"].branchVal = ((*jets)->at(iJet1).genPartonMotherId == 6*lep_charge &&
                                                           abs((*jets)->at(iJet2).genPartonMotherId) == 24 &&
                                                           abs((*jets)->at(iJet3).genPartonMotherId) == 24);
            branches["ttW_SS_B_CSV"].branchVal = (*jets)->at(iJet1).btagCombinedSecVertex;
            branches["ttW_SS_q_1_CSV"].branchVal = (*jets)->at(iJet2).btagCombinedSecVertex;
            branches["ttW_SS_q_2_CSV"].branchVal = (*jets)->at(iJet3).btagCombinedSecVertex;
            branches["ttW_SS_B_charge"].branchVal = lep_charge*(*jets)->at(iJet1).charge;
            branches["ttW_SS_top_mass_lep_B"].branchVal = top_mass_lep_B;
            branches["ttW_SS_W_mass_qq"].branchVal = W_mass_qq;
            branches["ttW_SS_W_sum_charge_qq"].branchVal = W_sum_charge_qq;
            branches["ttW_SS_ttbar_3j_MT_mass_ratio_Bqq"].branchVal = jet_123_vect_trans.M()/jet_123_vect.M();
          }
          ...
          if (log(ratio_bqq) > branches["Match_ttW_SS_bqq"].branchVal) {
            ...
            branches["ttW_SS_W_mass_qq"].branchVal = W_mass_qq;
            branches["ttW_SS_W_sum_charge_qq"].branchVal = W_sum_charge_qq;
            branches["ttW_SS_top_mass_b_qq"].branchVal = top_mass_b_qq;
            branches["ttW_SS_ttbar_3j_MT_mass_ratio_bqq"].branchVal = jet_123_vect_trans.M()/jet_123_vect.M();
          }
          ...
          for (unsigned int iJet4 = 0; iJet4 < (*jets)->size(); iJet4++) { 
            ...
            if (log(ratio_Bbqq) > branches["Match_ttW_SS_Bbqq"].branchVal) {
              branches["Match_ttW_SS_Bbqq"].branchVal = log(ratio_Bbqq);
              branches["Full_match_ttW_SS_Bbqq"].branchVal = ((*jets)->at(iJet1).genPartonMotherId == 6*lep_charge &&
                                                              (*jets)->at(iJet2).genPartonMotherId == -6*lep_charge &&
                                                              abs((*jets)->at(iJet3).genPartonMotherId) == 24 &&
              ...
              branches["ttW_SS_b_CSV"].branchVal = (*jets)->at(iJet2).btagCombinedSecVertex;
              branches["ttW_SS_q_1_CSV"].branchVal = (*jets)->at(iJet3).btagCombinedSecVertex;
              branches["ttW_SS_q_2_CSV"].branchVal = (*jets)->at(iJet4).btagCombinedSecVertex;
              branches["ttW_SS_B_charge"].branchVal = lep_charge*(*jets)->at(iJet1).charge;
              branches["ttW_SS_b_charge"].branchVal = lep_charge*(*jets)->at(iJet2).charge;
              branches["ttW_SS_top_mass_lep_B"].branchVal = top_mass_lep_B;
              branches["ttW_SS_W_mass_qq"].branchVal = W_mass_qq;
              branches["ttW_SS_W_sum_charge_qq"].branchVal = W_sum_charge_qq;
              branches["ttW_SS_top_mass_b_qq"].branchVal = top_mass_b_qq;
              branches["ttW_SS_ttbar_4j_MT_mass_ratio_Bbqq"].branchVal = ttbar_4j_MT_mass_ratio;
            }
          } //end iJet4
        } //end iJet3
      } //end iJet2
...
MatchTester_ttW_SS::~MatchTester_ttW_SS() {
