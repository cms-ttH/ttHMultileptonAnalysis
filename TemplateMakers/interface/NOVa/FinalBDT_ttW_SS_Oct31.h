#ifndef _FinalBDT_ttW_SS_Oct31_h
#define _FinalBDT_ttW_SS_Oct31_h
...
class FinalBDT_ttW_SS_Oct31: public KinematicVariable<double> {
...
public:
  ...
  FinalBDT_ttW_SS_Oct31(MatchTester_ttW_SS * _myMatchTester_ttW_SS,
...
FinalBDT_ttW_SS_Oct31::FinalBDT_ttW_SS_Oct31(MatchTester_ttW_SS * _myMatchTester_ttW_SS,
                                 MatchTester_ttbar_fake_SS * _myMatchTester_ttbar_fake_SS,
                                 MetLD * _myMetLD,
                                 BNjetCollection **_jetsByCSV,
                                 ThreeObjectKinematic<BNmetCollection,BNleptonCollection,BNjetCollection> * _myMTOfEverything):
  ...
  //std::cout << "Setting up FinalBDT_ttW_SS_Oct31" << std::endl;
  
  branches["FinalBDT_ttW_SS_Oct31"] = BranchInfo<double>("FinalBDT_ttW_SS_Oct31");
  branches["FinalBDT_ttW_SS_Oct31_QCD"] = BranchInfo<double>("FinalBDT_ttW_SS_Oct31_QCD");
  ...
  for( unsigned int jj = 0 ; jj < 6 ; ++jj ) { //6 readers for 6 BDTs
    ...
    TString dir = (string(getenv("CMSSW_BASE"))+"/src/ttHMultileptonAnalysis/TemplateMakers/data/NOVa/Oct31/BDT_weights_ttW_SS/").c_str();
...
void FinalBDT_ttW_SS_Oct31::evaluate() {
  if (this->evaluatedThisEvent) return;
  if ((*jetsByCSV)->size() < 2) return;
  evaluatedThisEvent = true;

  //std::cout << "Inside FinalBDT_ttW_SS_Oct31::evaluate()" << std::endl;
  ...
  for( unsigned int jj = 0 ; jj < 6 ; ++jj ) {
    ...
    if (jj == 0 && (*jetsByCSV)->size() == 2) branches["FinalBDT_ttW_SS_Oct31"].branchVal = annOut;
    if (jj == 1 && (*jetsByCSV)->size() == 3) branches["FinalBDT_ttW_SS_Oct31"].branchVal = annOut;
    if (jj == 2 && (*jetsByCSV)->size() >= 4) branches["FinalBDT_ttW_SS_Oct31"].branchVal = annOut;
    if (jj == 3 && (*jetsByCSV)->size() == 2) branches["FinalBDT_ttW_SS_Oct31_QCD"].branchVal = annOut;
    if (jj == 4 && (*jetsByCSV)->size() == 3) branches["FinalBDT_ttW_SS_Oct31_QCD"].branchVal = annOut;
    if (jj == 5 && (*jetsByCSV)->size() >= 4) branches["FinalBDT_ttW_SS_Oct31_QCD"].branchVal = annOut;
