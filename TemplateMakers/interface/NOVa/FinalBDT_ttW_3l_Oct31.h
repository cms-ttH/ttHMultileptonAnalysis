#ifndef _FinalBDT_ttW_3l_Oct31_h
#define _FinalBDT_ttW_3l_Oct31_h
...
class FinalBDT_ttW_3l_Oct31: public KinematicVariable<double> {
...
public:
  ...
  FinalBDT_ttW_3l_Oct31(BNjetCollection **_jets,
...
FinalBDT_ttW_3l_Oct31::FinalBDT_ttW_3l_Oct31(BNjetCollection **_jets,
                                 BNjetCollection **_mediumCSVJets,
                                 ThreeObjectKinematic<BNmetCollection,BNleptonCollection,BNjetCollection> * _myMTOfEverything,
                                 ThreeObjectKinematic<BNmetCollection,BNleptonCollection,BNjetCollection> * _myMassOfEverything,
                                 MatchTester_ttbar_fake_3l * _myMatchTester_ttbar_fake_3l,
  ...
  //std::cout << "Setting up FinalBDT_ttW_3l_Oct31" << std::endl;
  
  branches["FinalBDT_ttW_3l_Oct31"] = BranchInfo<double>("FinalBDT_ttW_3l_Oct31");
  ...
  for( unsigned int jj = 0 ; jj < 2 ; ++jj ) { //2 readers for 2 BDTs
    ...
    TString dir = (string(getenv("CMSSW_BASE"))+"/src/ttHMultileptonAnalysis/TemplateMakers/data/NOVa/Oct31/BDT_weights_ttW_3l/").c_str();
...
void FinalBDT_ttW_3l_Oct31::evaluate() {
  if (this->evaluatedThisEvent) return;
  if ((*jets)->size() < 1) return;
  evaluatedThisEvent = true;

  //std::cout << "Inside FinalBDT_ttW_3l_Oct31::evaluate()" << std::endl;
  ...
  for( unsigned int jj = 0 ; jj < 2 ; ++jj ) {
    ...
    if (jj == 0 && (*jets)->size() == 1) branches["FinalBDT_ttW_3l_Oct31"].branchVal = annOut;
    if (jj == 1 && (*jets)->size() >= 2) branches["FinalBDT_ttW_3l_Oct31"].branchVal = annOut;
