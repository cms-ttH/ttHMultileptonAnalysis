#ifndef _FinalBDT_ttZ_vs_ttbar_OS_Oct31_h
#define _FinalBDT_ttZ_vs_ttbar_OS_Oct31_h
...
class FinalBDT_ttZ_vs_ttbar_OS_Oct31: public KinematicVariable<double> {
...
public:
  ...
  FinalBDT_ttZ_vs_ttbar_OS_Oct31(BNjetCollection **_jets,
...
FinalBDT_ttZ_vs_ttbar_OS_Oct31::FinalBDT_ttZ_vs_ttbar_OS_Oct31(BNjetCollection **_jets,
                                                   BNjetCollection **_jets_40,
                                                   TwoObjectKinematic<BNleptonCollection, BNjetCollection> * _myMHT,
                                                   TwoObjectKinematic<BNleptonCollection,BNleptonCollection> * _myMassLepLep,
                                                   TwoObjectKinematic<BNleptonCollection,BNleptonCollection> * _myVectPtLepLep,
  ...
  //std::cout << "Setting up FinalBDT_ttZ_vs_ttbar_OS_Oct31" << std::endl;
  
  branches["FinalBDT_ttZ_vs_ttbar_OS_Oct31"] = BranchInfo<double>("FinalBDT_ttZ_vs_ttbar_OS_Oct31");
...
void FinalBDT_ttZ_vs_ttbar_OS_Oct31::evaluate() {
  if (this->evaluatedThisEvent) return;
  if ((*jets)->size() < 5) return;
  evaluatedThisEvent = true;

  //std::cout << "Inside FinalBDT_ttZ_vs_ttbar_OS_Oct31::evaluate()" << std::endl;
  ...
  for( unsigned int jj = 0 ; jj < 2 ; ++jj ) {
    ...
    if (jj == 0 && (*jets)->size() == 5) branches["FinalBDT_ttZ_vs_ttbar_OS_Oct31"].branchVal = annOut;
    if (jj == 1 && (*jets)->size() >= 6) branches["FinalBDT_ttZ_vs_ttbar_OS_Oct31"].branchVal = annOut;
