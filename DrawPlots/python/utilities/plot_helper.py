    ...
    def __init__(self, sample):
        dictionary = {
            ...
            'wz_lll': {'sample_type': 'MC',
                       ...
                       'x_section_error_ttV': 1.057*0.45, # xSec (20%), >=3 jets (40%)
                       #'x_section_error_ttV': 1.057*0.2, # xSec (20%)
            ...
            'wz_cc_lll': {'sample_type': 'MC',
                       ...
                       'x_section': 1.057, #*1.10, #CERN x_sec; equals (32.3*0.324*0.101) * 1.10
                       'x_section_error': 1.057*1.10*0.2, #CERN x_sec error
                       'x_section_error_ttV': 1.057*0.67, # xSec (20%), >=3 jets (40%), flavor (50%)
                       #'x_section_error_ttV': 1.057*0.54, # xSec (20%), flavor (50%)
                       'num_generated': 1987010}, #ND number processed
            ...
            'zz_llll': {'sample_type': 'MC',
                        ...
                        'x_section_error_ttV': 0.157*0.2, # xSec (20%)
            ...
            'zz_cc_llll': {'sample_type': 'MC',
                        ...
                        'x_section': 0.157, #*1.21, #CERN x_sec; why is it not (7.7*0.101*0.101) * 1.21
                        'x_section_error': 0.157*1.21*0.2, #CERN x_sec error
                        'x_section_error_ttV': 0.157*0.54, # xSec (20%), flavor (50%)
                        'num_generated': 4804217*76.0/78.0}, #ND number processed
            ...
            'www': {'sample_type': 'MC',
                    ...
                    'x_section_error_ttV': 0.08217*0.5, # xSec (50%)
            ...
            'wwz': {'sample_type': 'MC',
                    ...
                    'x_section_error_ttV': 0.0633*0.5, # xSec (50%)
            ...
            'wzz': {'sample_type': 'MC',
                    ...
                    'x_section_error_ttV': 0.01922*0.5, # xSec (50%)
            ...
            'zzz': {'sample_type': 'MC',
                    ...
                    'x_section_error_ttV': 0.004587*0.5, # xSec (50%) 
            ...
            'WpWpqq': {'sample_type': 'MC',
                       ...
                       'x_section_error_ttV': 0.2482*0.5, # xSec (50%) 
                       'num_generated': 99700},
            ...
            'WmWmqq': {'sample_type': 'MC',
                       ...
                       'x_section_error_ttV': 0.0889*0.5, # xSec (50%) 
            ...
            'WWDPI': {'sample_type': 'MC',
                      ...
                      'x_section_error_ttV': 0.5879*0.5, # xSec (50%) 
            ...
            'zjets': {'sample_type': 'MC',
                      ...
                      'x_section_error_ttV': 3505.7*0.3, # xSec (5%), >=5 jets (30%)
            ...
            'zjets_1p': {'sample_type': 'MC',
                      ...
                      'x_section_error_ttV': 666.7*0.3, # xSec (5%), >=5 jets (30%)
            ...
            'zjets_2p': {'sample_type': 'MC',
                      ...
                      'x_section_error_ttV': 215.1*0.3, # xSec (5%), >=5 jets (30%)
            ...
            'zjets_3p': {'sample_type': 'MC',
                      ...
                      'x_section_error_ttV': 66.07*0.3, # xSec (5%), >=5 jets (30%)
            ...
            'zjets_4p': {'sample_type': 'MC',
                      ...
                      'x_section_error_ttV': 27.38*0.3, # xSec (5%), >=5 jets (30%)
            ...
            'zjets_lowmass': {'sample_type': 'MC',
                              ...
                              'x_section_error_ttV': 14702*0.3, # xSec (5%), >=5 jets (30%)
            ...
            'zjets_cc': {'sample_type': 'MC',
                      ...
                      'x_section': 3505.7, 
                      'x_section_error': 3505.7*0.012, 
                      'x_section_error_ttV': 3505.7*0.43, # xSec (5%), >=5 jets (30%), flavor (30%) 
                      'num_generated': 30072710}, 
            ...
            'zjets_cc_1p': {'sample_type': 'MC',
                      ...
                      'x_section': 636.8, #666.7, #723.3,
                      'x_section_error': 666.7*0.012,
                      'x_section_error_ttV': 666.7*0.43, # xSec (5%), >=5 jets (30%), flavor (30%)
                      'num_generated': 24032562},
            ...
            'zjets_cc_2p': {'sample_type': 'MC',
                      ...
                      'x_section': 208.2, #215.1, #247.7,
                      'x_section_error': 215.1*0.012,
                      'x_section_error_ttV': 215.1*0.43, # xSec (5%), >=5 jets (30%), flavor (30%)
                      'num_generated': 2350806},
            ...
            'zjets_cc_3p': {'sample_type': 'MC',
                      ...
                      'x_section': 63.60, #66.07, #77.34,
                      'x_section_error': 66.07*0.012,
                      'x_section_error_ttV': 66.07*0.43, # xSec (5%), >=5 jets (30%), flavor (30%)
                      'num_generated': 10753491},
            ...
            'zjets_cc_4p': {'sample_type': 'MC',
                      ...
                      'x_section': 28.33, #27.38, #32.50,
                      'x_section_error': 27.38*0.012,
                      'x_section_error_ttV': 27.38*0.43, # xSec (5%), >=5 jets (30%), flavor (30%)
                      'num_generated': 6370630},
            ...
            'zjets_cc_lowmass': {'sample_type': 'MC',
                              ...
                              'x_section': 14702, #Questionable value ... could be 12460. See email chain with Rachel Yohay, Oct. 24 2013
                              'x_section_error': 14702*0.012,
                              'x_section_error_ttV': 14702*0.43, # xSec (5%), >=5 jets (30%), flavor (30%)
                              'num_generated': 37828841},
            ...
            'ttbar': {'sample_type': 'MC',
                      ...
                      'x_section_error_ttV': 245.8*0.1, # xSec (10%)
            ...
            'ttbar_cc': {'sample_type': 'MC',
                     ...
                     'x_section': 245.8, 
                     'x_section_error': 245.8*0.03, 
                     'x_section_error_ttV': 245.8*0.51, # xSec (10%), flavor (50%) 
                     'num_generated': 6912438+1362471},
            ...
            'ttbar_ll': {'sample_type': 'MC',
                       ...
                       'x_section_error_ttV': 0.105*245.8*0.1, # xSec (10%)
            ...
            'ttbar_cc_ll': {'sample_type': 'MC',
                       ...
                       'x_section': 0.105*245.8, 
                       'x_section_error': 0.105*245.8*0.03,
                       'x_section_error_ttV': 0.105*245.8*0.51, # xSec (10%), flavor (50%)
                       'num_generated': 12100452},
            ...
            'ttbarW': {'sample_type': 'MC',
                       ...
                       'x_section_error_ttV': 0.203*0.123, # QCDscale_ttW (10%), pdf_qqbar (7.2%)
            ...
            'ttbarZ': {'sample_type': 'MC',
                       ...
                       'x_section_error_ttV': 0.206*0.137,  # QCDscale_ttZ (11%), pdf_gg (8.1%)
            ...
            'ttbarG': {'sample_type': 'MC',
                       ...
                       'x_section_error_ttV': 1.444*1.8*0.5, # xSec (50%)
            ...
            'ttbarGStar_ee': {'sample_type': 'MC',
                              ...
                              'x_section_error_ttV': 1.5*0.02724*0.104*0.5, # xSec (50%)
                              'num_generated': 13517},
            ...
            'ttbarGStar_mm': {'sample_type': 'MC',
                       ...
                       'x_section_error_ttV': 1.5*0.01233*0.141*0.5, # xSec (50%)
                       'num_generated': 8019},
            ...
            'ttbarGStar_tt': {'sample_type': 'MC',
                       ...
                       'x_section_error_ttV': 1.5*0.00133*0.038*0.5, # xSec (50%)
                       'num_generated': 17289},
            ...
            'ttbarWW': {'sample_type': 'MC',
                        ...
                        'x_section_error_ttV': 0.002037*0.5, # xSec (50%)
            ...
            'tttt': {'sample_type': 'MC',
                     ...
                     'x_section_error_ttV': 0.000716*0.5, # xSec (50%)
            ...
            'tbZ_ll': {'sample_type': 'MC',
                     ...
                     'x_section_error_ttV': 0.0114*0.5, # xSec (50%)
            ...
            'ttH125': {'sample_type': 'MC',
                       ...
                       'x_section': 0.1302,
                       'x_section_error': 0.0,
                       'x_section_error_ttV': 0.1302*0.1, # QCDscale_ttH (6%), pdf_gg (8.1%)
            ...
            'MuEG_NP_sideband': {'sample_type': 'NP_sideband',
                     ...
                     'x_section': 1,
                     'x_section_error': 0.5,
                     'x_section_error_ttV': 0.5, # NP muon rate (60%), NP electron rate (40%)
                     'num_generated': 1},
            ...
            'DoubleMu_NP_sideband': {'sample_type': 'NP_sideband',
                         ...
                         'x_section': 1,
                         'x_section_error': 0.5,
                         'x_section_error_ttV': 0.6, # NP muon rate (60%), NP electron rate (40%) 
                         'num_generated': 1},
            ...
            'DoubleElectron_NP_sideband': {'sample_type': 'NP_sideband',
                                           ...
                                           'x_section': 1,
                                           'x_section_error': 0.5,
                                           'x_section_error_ttV': 0.4, # NP muon rate (60%), NP electron rate (40%) 
                                           'num_generated': 1},
            ...
            'MuEG_QF_sideband': {'sample_type': 'QF_sideband',
                                 ...
                                 'x_section': 1,
                                 'x_section_error': 0.3,
                                 'x_section_error_ttV': 0.3, # Charge flip rate (30%)
                                 'num_generated': 1},

            'MuEG_QF_sideband_neg': {'sample_type': 'QF_sideband',
                                     'is_signal': False,
                                     'x_section': 1,
                                     'x_section_error': 0.3,
                                     'x_section_error_ttV': 0.3, # Charge flip rate (30%)
            ...
            'DoubleElectron_QF_sideband': {'sample_type': 'QF_sideband',
                                           ...
                                           'x_section': 1,
                                           'x_section_error': 0.4,
                                           'x_section_error_ttV': 0.42, # Charge flip rate (30%) squared
                                           'num_generated': 1},

            'DoubleElectron_QF_sideband_neg': {'sample_type': 'QF_sideband',
                                               'is_signal': False,
                                               'x_section': 1,
                                               'x_section_error': 0.4,
                                               'x_section_error_ttV': 0.42, # Charge flip rate (30%) squared
            ...
            'inclusive_data_QF_sideband': {'sample_type': 'QF_sideband',
                                           ...
                                           'x_section': 1,
                                           'x_section_error': 0.5,
                                           'x_section_error_ttV': 0.36, # Charge flip rate (30%) average
                                           'num_generated': 1},
